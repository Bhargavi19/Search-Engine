  ...
  placeAlerts: function (parkCode,jsonSrc,isParkHomepage) {
    ...
    if ( 'CEDATA' in data ) {
      ...
      */
      ...
      if ( show_alerts == 1 && alertsAuto == 1 && window_width > 1024 ) {
...
NPS.globalAlert = {
  ...
  display:function() {	  
		...
		bannerContent += '<h4 class="ShutdownBanner__Heading">Government Shutdown</h2>';
		bannerContent += '<div class="ShutdownBanner__Description">Due to lack of appropriated funding, NPS.gov is not currently being maintained or updated. Website errors may be encountered and content on NPS.gov may not be current or accurately describe operating condtions for any National Park Service site.</div>';
